...
<form action="" method="post">
    ...
    <button name="addState">Add</button>
</form>
    ...
    <table>
        ...
        <tbody>   
            ...
            while($row = mysqli_fetch_assoc($viewAllState)){
                ...
                echo "<td><a onClick=\"javascript: return confirm('Are You Sure?');\" href='pincode.php?stateDelete={$state_id}'>DELETE</a></td>";
                echo "<td><a href='pincode.php?stateEdit={$state_id}'>EDIT</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
